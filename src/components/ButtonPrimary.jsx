...
const ButtonPrimary = (props) => {
  const fontSize = `text-green font-bold transition-colors duration-300 group-hover:text-white ${props.size}`;
  return (
    <Link
      className=" border-green border-2 flex items-center space-x-3 px-3 py-2 rounded-md hover-1 group"
      to={props.to}
    >
